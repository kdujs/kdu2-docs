(function () {
  ...
  function initHashLevelRedirects() {
    ...
    checkForHashRedirect(/components\.html$/, {
      ...
      'Customizing-Component-k-model':
        '/v2/guide/components-custom-events.html#Customizing-Component-k-model',
      ...
      'Cheap-Static-Components-with-k-once':
        '/v2/guide/components-edge-cases.html#Cheap-Static-Components-with-k-once'
    })
  ...
  function initApiSpecLinks () {
    ...
    function createSourceSearchPath (query) {
      query = query
        .replace(/\([^\)]*?\)/g, '')
        .replace(/(Kdu\.)(\w+)/g, '$1$2" OR "$2')
        .replace(/vm\./g, 'Kdu.prototype.')
      return 'https://github.com/search?utf8=%E2%9C%93&q=repo%3Akdujs%2Fkdu+extension%3Ajs+' + encodeURIComponent('"' + query + '"') + '&type=Code'
    }
  }
  ...
  function initLocationHashFuzzyMatching () {
    ...
    if (!hashTarget) {
      ...
      var edgeCases = {
        'kdu-set-target-key-value': 'kdu-set'
      }
